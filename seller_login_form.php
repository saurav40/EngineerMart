                    ...
                    <div class="col-md-4 col-md-offset-4">
                        <div class="panel panel-primary" >
                            ...
                            <div class="panel-body">
                                <p class="text-warning"><b>Login to sell your product</b><p>
...
<!--                                        <div><?php echo $_GET['password_error']; ?></div>-->
                                    ...
                                    <button type="submit" name="save" class="btn btn-primary">Login</button><br>
									<div><a href="change_seller_passwd.php"><b>Change password ?</b></a></div>
                                </form><br/>
                            </div>
                            <div class="panel-footer"><p>Don't have an account? <a href="seller_registration_from.php">Register</a></p></div>
                        </div>
                    </div>
                </div>
            </div>
